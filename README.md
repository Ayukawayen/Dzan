...
### [取得新將領](https://ayukawayen.github.io/Dzan/queue.html) ###


## 將領姓名 ##

將領均為單姓單名，姓候選字125字，名候選字192字，見[姓名候選用字清單](https://github.com/Ayukawayen/Dzan/blob/Pre-Alpha/%E5%A7%93%E5%90%8D%E5%80%99%E9%81%B8%E7%94%A8%E5%AD%97%E6%B8%85%E5%96%AE.md)，計24000姓名，將領之姓名不會重複。
(存在因BUG而姓名重複者)

姓名在將領產生時由伺服器填入，與Token ID無關。
...
無傾向之將領，兵種配置強制為[1000,1000,1000]，忽略Token ID內兵種配置之位元值。
...
兵種傾向為無傾向之將領，兵種配置強制為[1000,1000,1000]，忽略此位元值之結果。
...
將領之攻擊力 = 25 + (n0 + n1 + n2 + n3 + n4)；範圍為25-100。
將領之防禦力 = 100 - (n0 + n1 + n2 + n3 + n4)；範圍為25-100。
